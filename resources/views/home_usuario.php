    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="" class="logo">
          ...
          <font color="#ffffff">
          <span class="logo-lg"><b>Cesyc</b>Adm</span>
          </font>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                     Usuario
                      <small><font color="black">Elaborado en el año 2017</font></small>
                    </p>
                  </li>
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="#" class="btn btn-default btn-flat" onclick="mostrarficha(<?= $usuario->id; ?>);">Perfil</a>
                    </div>
