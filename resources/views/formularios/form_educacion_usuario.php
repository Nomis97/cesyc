<div class="row">  
 ...
 <div class="col-md-4">
 	    ...
 	    <div class="box box-primary">
            ...
            </div><!-- /.box-header  class="form-horizontal form_entrada"  class="formarchivo"  enctype="multipart/form-data"-->
            ...
            <form  id="f_agregar_educacion"  method="post"  action="agregar_educacion_usuario" class="form-horizontal form_entrada" >                
                 ...
                 <input type="hidden" name="id_edu" value="<?= $usuario->id; ?>">   
	             	  ...
	             	  <div class="form-group col-xs-12">
                        ...
                        <div class="form-group col-xs-12">
                           ...
                           <div class="form-group col-xs-12">
                              ...
                              <input type="text" class="form-control" id="ins_educacion" name="ins_educacion" value="" >
                         </div>  

                         <div class="form-group col-xs-12">
                              <label for="apellido">Año de Graduacion</label>
                              <input type="text" class="form-control" id="anio_educacion" name="anio_educacion" value="" >
                         </div>
