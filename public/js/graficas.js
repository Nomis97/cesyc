...
function cargar_grafica_nucleo(){

var options={
     // Build the chart
     
            chart: {
                renderTo: 'div_grafica_nucleo',
            ...
            title: {
                text: 'Grafica invetigadores por Núcleo'
            },
            tooltip: {
...
$("#div_grafica_nucleo").html( $("#cargador_empresa").html() );

var url = "grafica_nucleo";
...
function cargar_grafica_pfg(){

var options={
     // Build the chart
     
            chart: {
                renderTo: 'div_grafica_pfg',
                plotBackgroundColor: null,
                plotBorderWidth: null,
                plotShadow: false,
                type: 'pie'
            ...
            title: {
                text: 'Grafica invetigadores por Área de Investigación'
            },
            tooltip: {
                pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
            },
...
$("#div_grafica_pfg").html( $("#cargador_empresa").html() );
